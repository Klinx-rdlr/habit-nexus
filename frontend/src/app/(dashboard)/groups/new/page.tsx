...
export default function CreateGroupPage() {
  ...
  useEffect(() => {
    document.title = 'Create Group | HabitMap';
  }, []);
  ...
  if (createdGroup) {
    return (
      <div className="mx-auto max-w-md">
        <div className="rounded-xl border border-surface-200 bg-surface-0 p-8 text-center dark:border-surface-800 dark:bg-surface-900">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            rows={3}
            className="block w-full rounded-lg border border-surface-200 px-3 py-2.5 text-sm transition-colors placeholder:text-surface-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-1 dark:border-surface-700 dark:bg-surface-800 dark:text-surface-100 dark:focus:ring-offset-surface-900"
          />
        </div>
